...
class CollectListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val items = listOf(
            CollectItem(R.drawable.ic_placeholder, "냉장고", "내용: 제품이 고장났습니다.", "처리중"),
            CollectItem(R.drawable.ic_placeholder, "그래픽카드", "내용: 그래픽카드 이상.", "수거중"),
            CollectItem(R.drawable.ic_placeholder, "세탁기", "내용: 세탁기가 작동하지 않습니다.", "수거완료")
        )
